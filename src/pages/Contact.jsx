...
const Contact = () => {
  return (
    <div className="page-container">
      <Helmet>
        <title>Contatti - Judo Kihon Bovolone</title>
        <meta
          name="description"
          content="Trova la palestra dell'A.S.D. Judo Kihon a Bovolone. Orari, indirizzo, email e numeri di telefono per contattarci."
        />
      </Helmet>
      ...
      <section className="section">
        <ScrollSection>
          ...
          <p className="section-subtitle">
            Per qualunque segnalazione, avviso o informazione non esitare a contattarci.
          </p>
        </ScrollSection>
            ...
            <ScrollSection delay={0}>
              <div className="info-card">
                ...
                <div>
                  <h3>Dove Trovarci</h3>
                  <p>
                    <strong>JUDO KIHON — BOVOLONE</strong>
                  </p>
            ...
            <ScrollSection delay={100}>
              <div className="info-card">
                ...
                <div>
                  <h3>Telefoni</h3>
                  <p>
                    <strong>Marco Bertolotto:</strong> (+39) 340 940 7514
                  </p>
                  <p>
                    <strong>Paolino Tarocco:</strong> (+39) 339 874 1853
                  </p>
                </div>
              </div>
            </ScrollSection>
            ...
            <ScrollSection delay={200}>
              <div className="info-card">
                ...
                <div>
                  <h3>Email</h3>
                  <p>
                    <a href="mailto:info@judokihon.it" className="text-link">
                      info@judokihon.it
                    </a>
                  </p>
                </div>
            ...
            <ScrollSection delay={300}>
              <div className="info-card">
                ...
                <div>
                  ...
                  <p>
                    <a
                      href="http://www.judofijlkam-veneto.it/"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-link"
                    >
                      www.judofijlkam-veneto.it
                    </a>
                  </p>
                </div>
              </div>
